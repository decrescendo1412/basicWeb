...
console.log("addNum(1,2,3,4,5) : " + addNum(1,2,3,4,5));

// 전개구문으로 배열과 배열을 연결 가능.
let animal = ["brid", "dog", "cat"];
...
// Es2015 이후에는 [](대괄호)를 사용 할 수 있다.
const book = {
    title : 'JAVA SCRIPT',
    pages : 650
};
// 프로퍼티 추가.
// book.publishedDate="2023-11";

// 대괄호 표기법으로 사용하면 가능. []안에는 문자열로 작성해야 함.
book["published date"] = "2023-11";
console.log("book : ", book);

// ES2015 부터는 함수나 계산식을 프로퍼티 이름으로 사용 가능.
function fn() {
...
// console.log("member[tel]() : ", member[tel]());
