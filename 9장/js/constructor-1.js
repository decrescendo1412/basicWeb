...
const book2 = new Book("JAAVA", 650, true);
...
const book4 = new Book("JAAVA", 650, true);

document.write(`<hr><h2>생성자 함수로 객체 만들기</h2>`);
